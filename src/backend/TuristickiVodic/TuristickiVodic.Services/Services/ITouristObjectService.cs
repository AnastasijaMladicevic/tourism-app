...
namespace TuristickiVodic.Services.Services
{
    public interface ITouristObjectService
    {
        ...
        Task<TouristObjectDto?> GetByIdAsync(int id, string lang = "sr");
        Task<TouristObjectDto?> GetMineByIdAsync(int id, int userId, string lang = "sr");
        Task<TouristObjectDto?> GetForManagerByIdAsync(int id, int userId, string lang = "sr");
