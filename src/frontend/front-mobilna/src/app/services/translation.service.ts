...
const TRANSLATIONS: Record<string, Record<AppLanguage, string>> = {
  ...
  'language.infoTitle': { sr: 'Promena jezika se primenjuje odmah', en: 'Language changes apply instantly' },
  'language.infoBody': {
    sr: 'Nakon cuvanja, kompletan mobilni interfejs ce odmah biti prikazan na izabranom jeziku.',
    en: 'After saving, the entire mobile interface will switch to the selected language immediately.',
  },
