...
const TRANSLATIONS: Record<string, TranslationEntry> = {
  ...
  'common.cancel': { sr: 'Otkaži', en: 'Cancel', es: 'Cancelar' },
  ...
  'editProfile.cancelChanges': { sr: 'Otkaži izmene', en: 'Cancel changes', es: 'Cancelar cambios' },
...
const LITERAL_TRANSLATIONS: Record<string, TranslationEntry> = Object.fromEntries([
  ...
  literal('permissions', 'permisos', 'dozvola'),
  literal('Show all permissions', 'Mostrar todos los permisos', 'Prikaži sve dozvole'),
  literal('Role permissions', 'Permisos del rol', 'Dozvole uloge'),
  literal('Permissions are inherited from the administrator role and determine access to system features.', 'Los permisos se heredan del rol de administrador y determinan el acceso a las funciones del sistema.', 'Dozvole su nasleđene iz administratorske uloge i određuju pristup sistemskim funkcionalnostima.'),
  literal('View admin dashboard', 'Ver panel de administrador', 'Dashboard pregled'),
  literal('Open the admin overview at /api/admin/dashboard/overview.', 'Abre la vista general de administrador en /api/admin/dashboard/overview.', 'Pristup dashboardu i pregled statistika.'),
  literal('Manage user accounts', 'Gestionar cuentas de usuario', 'Korisnički nalozi'),
  literal('View users, inspect user details, and find users by email.', 'Ver usuarios, revisar detalles y buscar usuarios por correo.', 'Pregled, kreiranje i upravljanje korisničkim nalozima.'),
  literal('Manage admin access', 'Gestionar acceso administrativo', 'Pristup administratora'),
  literal('Register manager and admin accounts, plus review creator requests.', 'Registrar cuentas de gerentes y administradores, y revisar solicitudes de creadores.', 'Pristup administrativnom panelu i podešavanjima sistema.'),
  literal('Moderate users', 'Moderar usuarios', 'Moderacija korisnika'),
  literal('Approve, reject, demote, ban, unban, activate, or deactivate accounts.', 'Aprobar, rechazar, degradar, bloquear, desbloquear, activar o desactivar cuentas.', 'Moderiranje korisnika i upravljanje njihovim aktivnostima.'),
  literal('Manage destinations', 'Gestionar destinos', 'Destinacije'),
  literal('Create, update, assign managers to, or delete destinations.', 'Crear, actualizar, asignar gerentes o eliminar destinos.', 'Kreiranje, uređivanje i upravljanje destinacijama.'),
  literal('Control destination images', 'Controlar imágenes de destinos', 'Upravljanje slikama destinacija'),
  literal('Add destination images and handle destination edit locks.', 'Añadir imágenes de destinos y gestionar bloqueos de edición.', 'Dodavanje i uređivanje slika destinacija.'),
  literal('Review manager reports', 'Revisar informes de gerentes', 'Izveštaji menadžera'),
  literal('List all reports and review pending manager reports.', 'Listar todos los informes y revisar informes pendientes de gerentes.', 'Kreiranje i pregled menadžerskih izveštaja.'),
  literal('Password Change', 'Cambio de contraseña', 'Promena lozinke'),
  literal('Regular password updates are recommended for account security.', 'Se recomienda actualizar la contraseña con regularidad por la seguridad de la cuenta.', 'Preporučuje se redovno ažuriranje lozinke radi bezbednosti naloga.'),
  ...
  literal('Cancel', 'Cancelar', 'Otkaži'),
