...
const TRANSLATIONS: Record<string, Record<TranslationLocale, string>> = {
  ...
  'layout.openMenu': { sr: 'Otvori meni', en: 'Open menu' },
  'layout.closeMenu': { sr: 'Zatvori meni', en: 'Close menu' },
  'layout.settings': { sr: 'Podesavanja', en: 'Settings' },
  'layout.mainMenu': { sr: 'Glavni meni', en: 'Main Menu' },
  'layout.system': { sr: 'Sistem', en: 'System' },
  'layout.moderation': { sr: 'Moderacija', en: 'Moderation' },
  'layout.dashboard': { sr: 'Kontrolna tabla', en: 'Dashboard' },
  'layout.destinations': { sr: 'Destinacije', en: 'Destinations' },
  'layout.usersRoles': { sr: 'Korisnici i uloge', en: 'Users & Roles' },
  'layout.mapView': { sr: 'Prikaz mape', en: 'Map View' },
  'layout.activityLog': { sr: 'Evidencija aktivnosti', en: 'Activity Log' },
  'layout.objects': { sr: 'Objekti', en: 'Objects' },
  'layout.activities': { sr: 'Aktivnosti', en: 'Activities' },
  'layout.events': { sr: 'Dogadjaji', en: 'Events' },
  'layout.reviews': { sr: 'Recenzije', en: 'Reviews' },
  'layout.reviewsReplies': { sr: 'Recenzije i odgovori', en: 'Reviews & Replies' },
  'layout.creatorReports': { sr: 'Izvestaji kreatora', en: 'Creator Reports' },
  'layout.localities': { sr: 'Lokaliteti', en: 'Localities' },
  'layout.signOut': { sr: 'Odjavi se', en: 'Sign Out' },
  'layout.profile': { sr: 'Profil', en: 'Profile' },
  'layout.notifications': { sr: 'Obavestenja', en: 'Notifications' },
  'layout.unread': { sr: 'neprocitano', en: 'unread' },
  'layout.markAllRead': { sr: 'Oznaci sve kao procitano', en: 'Mark all read' },
  'layout.allCaughtUp': { sr: 'Sve je pregledano', en: 'All caught up' },
  'layout.noNotifications': { sr: 'Jos nema obavestenja.', en: 'No notifications yet.' },
  'layout.loadingNotifications': { sr: 'Ucitavanje obavestenja…', en: 'Loading notifications…' },
  'layout.justNow': { sr: 'Upravo sada', en: 'Just now' },
  'layout.minutesAgo': { sr: 'pre {{count}}m', en: '{{count}}m ago' },
  'layout.hoursAgo': { sr: 'pre {{count}}h', en: '{{count}}h ago' },
  'layout.daysAgo': { sr: 'pre {{count}}d', en: '{{count}}d ago' },
