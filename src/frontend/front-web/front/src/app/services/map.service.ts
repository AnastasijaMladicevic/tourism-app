...
// Production builds can load Leaflet and markercluster through bundled scripts.
// Prefer the shared global runtime instance so the plugin augments the same Leaflet object.
